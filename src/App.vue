...
export default {
    ...
    methods: {
        loadAnimesAndCheckCors: async function () {
            try {
                animesStore.vf = await (await fetch('https://deril.ketsuna.workers.dev/animes-search-vf.json')).json();
                animesStore.vostfr = await (await fetch('https://deril.ketsuna.workers.dev/animes-search-vostfr.json')).json();
            } catch (e) {
